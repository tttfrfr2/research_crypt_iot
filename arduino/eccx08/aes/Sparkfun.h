...
#define RESPONSE_AES_EBC_SIZE 16
#define CRC_SIZE             2
...
#define COMMAND_OPCODE_AES_EBC 0x51 // For AES-EBC encrypt or decrypt
...
#define AES_MODE_ENCRYPT_POSITION0  0x00
#define AES_MODE_ENCRYPT_POSITION1  0x40
#define AES_MODE_ENCRYPT_POSITION2  0x80
#define AES_MODE_ENCRYPT_POSITION3  0xC0

#define AES_MODE_DECRYPT_POSITION0  0x01
#define AES_MODE_DECRYPT_POSITION1  0x41
#define AES_MODE_DECRYPT_POSITION2  0x81
#define AES_MODE_DECRYPT_POSITION3  0xC1
...
#define ADDRESS_DATA_WRITE_BLOCK_0 0x0000
#define ADDRESS_DATA_WRITE_BLOCK_1 0x0100
#define ADDRESS_DATA_WRITE_BLOCK_2 0x0200
#define ADDRESS_DATA_WRITE_BLOCK_3 0x0300

#define DATA_SLOT_9 0x0048
...
class ATECCX08A {
  ...
  boolean aesEncryptEBC(uint16_t slot, uint8_t *data, uint8_t *encrypted);
  boolean aesDecryptEBC(uint16_t slot, uint8_t *data, uint8_t *decrypted);
  private:
